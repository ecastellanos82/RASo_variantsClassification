...
Automatic_criteria_AMCG<- function(id){
  ...
  if(length(group_position)!=0&pm5==0){
    ...
    if (length(group_position)==2){ # it looks if = 2 to consider group of genes 2 that are 3 genes.
      ...
      criteria["PM5_supporting",1][pm5_analogs_groups2$classification=="pat"|pm5_analogs_groups2$classification=="ppat"]<-1 #assignem 1 si és pat o ppat
...
Final_classification(Manual_criteria)
